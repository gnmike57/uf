...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataflow', action='store_const', const='dataflow', help='Indicates that the task type is dataflow.')
    parser.add_argument('--instantiation', action='store_const', const='instantiation', help='Indicates that the task type is instantiation.')
    parser.add_argument('--execution', action='store_const', const='execution', help='Indicates that the task type is execution.')
    parser.add_argument('--task_path', type=str, default=_configs['TASKS_HUB'], help='Path to the task file or directory.')
...
def process_task(task_path: str, task_type: str) -> None:
    ...
    """
    from ufo.dataflow.data_flow_controller import DataFlowController
    try:
