...
def verify_r4(
    ...
    if dry_run:
        return {
            ...
            "details": "[DRY RUN] Stage R4 Complex BankFidelity Task verification simulated successfully.",
        }
    ...
    # Check for exported report file on Desktop (must exist and be non-empty)
    desktop = get_desktop_dir()
...
def get_stage_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Execute a more advanced, multi-step interaction within BankFidelity.",
