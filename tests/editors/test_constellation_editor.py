...
def test_bulk_operations():
    ...
    schema = TaskConstellationSchema(
        name="bulk_constellation",
        tasks=tasks_config,
...
def test_advanced_operations():
    ...
    tasks = [
        {"task_id": "A", "name": "Task A", "description": "Task A"},
        {"task_id": "B", "name": "Task B", "description": "Task B"},
        {"task_id": "C", "name": "Task C", "description": "Task C"},
        {"task_id": "D", "name": "Task D", "description": "Task D"},
    ]
